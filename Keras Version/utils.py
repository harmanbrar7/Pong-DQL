...
def plotLearning(x, scores, epsilons, filename, window, lines=None):  #made the change here
    fig=plt.figure()
...
class PreProcessFrame(gym.ObservationWrapper):
    def __init__(self, env=None):
        ...
        self.observation_space = gym.spaces.Box(low=0, high=225, shape=(80,80,1), dtype=np.uint8)
    ...
    def process(frame):
        ...
        #make it greyscale, we dont care about rgb
